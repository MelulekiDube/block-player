...
class BlockBreakerPanel extends JPanel implements KeyListener {
    private static String FILE_LOCATION = "resources/";
	...
	paddle = new Block(175, 480, 150, 25, FILE_LOCATION+"paddle.png");
	animate = new Animate(this);
	thread = new Thread(animate);
	for (int i = 0; i < 8; i++) {
	    blocks.add(new Block(i * 60 + 2, 0, 60, 25, FILE_LOCATION+"blue.png"));
	}
	for (int i = 0; i < 8; i++) {
	    blocks.add(new Block(i * 60 + 2, 25, 60, 25, FILE_LOCATION+"red.png"));
	}
	for (int i = 0; i < 8; i++) {
	    blocks.add(new Block(i * 60 + 2, 50, 60, 25, FILE_LOCATION+"green.png"));
	}
	for (int i = 0; i < 8; i++) {
	    blocks.add(new Block(i * 60 + 2, 75, 60, 25, FILE_LOCATION+"yellow.png"));
	}
	ball.add(new Block(237, 437, 25, 25, FILE_LOCATION+"ball.png"));
	Random r = new Random();
